...
export default function EditIcon(props: SVGProps<any>) {
  return (
    <svg
      width="24"
      height="24"
      ...
      {...props}
    >
      <g clipPath="url(#clip0_6726_3742)">
        <g clipPath="url(#clip1_6726_3742)">
          <path
      ...
      <defs>
        <clipPath id="clip0_6726_3742">
          <rect width="24" height="24" fill="white" />
        </clipPath>
        <clipPath id="clip1_6726_3742">
          <rect width="24" height="24" fill="white" />
        </clipPath>
      </defs>
    </svg>
